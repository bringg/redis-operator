...
func objectUpdateNeeded(got, want k8sruntime.Object) (needed bool) {
	...
	case *policyv1.PodDisruptionBudget:
		return podDisruptionBudgetUpdateNeeded(got.(*policyv1.PodDisruptionBudget), want.(*policyv1.PodDisruptionBudget))
	case *appsv1.StatefulSet:
...
func generatePodDisruptionBudget(r *k8sv1alpha1.Redis) *policyv1.PodDisruptionBudget {
...
func podDisruptionBudgetUpdateNeeded(got, want *policyv1.PodDisruptionBudget) (needed bool) {
